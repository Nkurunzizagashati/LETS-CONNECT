<div class="">
    ...
    <div class=" flex gap-20">
        ...
        <div class=" flex justify-center items-center content-center fixed w-[25%] top-0 bottom-0 p-1 border shadow-lg shadow-slate-500">
            
            <div class=" w-full gap-8 flex flex-col justify-center items-center content-center">
                <div class=" bg-slate-800 w-full text-center text-white font-bold p-4 rounded hover:bg-slate-600 hover:cursor-pointer">
                ...
                <div class=" bg-slate-800 w-full text-center text-white font-bold rounded hover:bg-slate-600 hover:cursor-pointer">
                    <a wire:navigate href="{{route('profile.edit')}}" class=" w-full p-4 block">
                        <i class="fa-solid fa-user fa-lg"></i>
                        Profile</a>           
                </div>
                <form method="POST" action="{{route('logout')}}" class=" flex justify-center items-center bg-slate-800 w-full text-center text-white font-bold rounded hover:bg-slate-600 hover:cursor-pointer">
                    @csrf
        ...
        <div class=" w-[100%] z-10 ml-[26%]">
            ...
            <div class=" rounded-md shadow-md shadow-slate-500 p-4">
                <div class=" flex flex-col items-center justify-center  gap-8">
                    ...
                    <button class=" w-full bg-blue-500 hover:bg-blue-400 rounded text-white py-2 px-4">Read more</button>
                </div>
                <div class=" flex gap-10 border border-slate-500 p-4 rounded justify-center items-center">
                    <i wire:click="test" class="fa-solid hover:text-red-500 hover:cursor-pointer fa-lg fa-heart"></i>
